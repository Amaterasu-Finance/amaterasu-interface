...
const AMATERASU_DEFUALT_LIST =
  'https://raw.githubusercontent.com/Amaterasu-Finance/default-token-list/main/src/tokens/aurora-mainnet.json'
...
export const DEFAULT_LIST_OF_LISTS: string[] = [
  ...
  KLEROS_LIST,
  GEMINI_LIST,*/
  AMATERASU_DEFUALT_LIST,
  ...UNSUPPORTED_LIST_URLS // need to load unsupported tokens as well
]

// default lists to be 'active' aka searched across
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [AMATERASU_DEFUALT_LIST]
